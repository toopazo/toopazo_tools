...
class UlgProcess:
    def __init__(self, logdir, tmpdir, plotdir):
        ...
        self.ulgplotter = UlgPlotter(self.logdir, self.tmpdir, self.plotdir)
    ...
    def process_file(self, ulgfile):
        ...
        self.ulgplotter.plot_actuator_controls_0_0(ulgfile, closefig)
        self.ulgplotter.plot_actuator_outputs_0(ulgfile, closefig)
        self.ulgplotter.plot_vehicle_local_position_0(ulgfile, closefig)
        # self.ulgplotter.plot_manual_control_setpoint_0(ulgfile, closefig)
        # self.ulgplotter.plot_vehicle_rates_setpoint_0(ulgfile, closefig)
        self.ulgplotter.plot_vehicle_attitude_0_deg(ulgfile, closefig)

        # self.ulgplotter.plot_nwindow_hover_pos(ulgfile, closefig)
        self.ulgplotter.plot_nwindow_hover_vel(ulgfile, closefig)
