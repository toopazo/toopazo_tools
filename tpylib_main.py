...
if __name__ == '__main__':
    ...
    foldername_arr = FileFolderUtils.get_foldername_arr(bdir, 'Angle')
    ...
    # python /home/tzo4/Dropbox/tomas/software/tpylib_main.py --bdir .
    # python tpylib_main.py --file logs/log_49_2019-1-16-13-22-24.ulg
