...
# import argparse
# import subprocess
from tpylib_utilities import FileFolderUtils
# import csv
...
class UlgPlotter:
    ...
    def plot_vehicle_attitude_0_deg(self, ulgfile, closefig):
        [csvname, x, y0, y1, y2] = \
        ...
        PlotToFig.savecf(jpgfilename, closefig)

    def plot_vehicle_rates_setpoint_0(self, ulgfile, closefig):
    ...
    def plot_manual_control_setpoint_0(self, ulgfile, closefig):
        [csvname, x, y0, y1, y2, y3] = \
    ...
    def plot_vehicle_local_position_0(self, ulgfile, closefig):
        ...
        # PlotToFig.ax3_x1_y3(ax_arr, x, xlabel, y_arr, ylabel_arr)
        PlotToFig.ax3_x1_y6(ax_arr, x, xlabel, y_arr, ylabel_arr)
        # ax0.set_ylim([-1, 1])
        # ax1.set_ylim([-1, 1])
        # ax2.set_ylim([-1, 1])
        ax2.legend(['pos', 'vel'])
    ...
    def plot_actuator_controls_0_0(self, ulgfile, closefig):
        [csvname, x, y0, y1, y2, y3] = \
    ...
    def plot_actuator_outputs_0(self, ulgfile, closefig):
        ...
        jpgfilename = self.get_jpgfilename(self.plotdir, ulgfile, csvname + "_a")
        PlotToFig.savecf(jpgfilename, closefig)
        ...
        jpgfilename = self.get_jpgfilename(self.plotdir, ulgfile, csvname + "_b")
        PlotToFig.savecf(jpgfilename, closefig)

    def plot_nwindow_hover_pos(self, ulgfile, closefig):
        [csvname, x, y0, y1, y2, y3, y4, y5] = \
            UlgParser.get_vehicle_local_position_0(ulgfile, self.tmpdir)
    ...
    def plot_nwindow_hover_vel(self, ulgfile, closefig):
        [csvname, x, y0, y1, y2, y3, y4, y5] = \
            UlgParser.get_vehicle_local_position_0(ulgfile, self.tmpdir)
